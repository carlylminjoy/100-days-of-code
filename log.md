...
**Today's Progress**: Finished Wikipedia Viewer project.
...
**Today's Progress**: Continued working on Wikipedia Viewer project. 

**Thoughts:** Found out about github pages and created a basic site so my projects are easily viewable online. Took a while but found a way to compose a request to retrieve the information I needed from the media wiki API. Things are beginning to feel more complicated as I get through these projects and the curriculum, but I'm gaining confidence in my ability to work things out. I feel like I'm past the hard part of learning how to code, which is believing that I can.
